  ...
  return (
    <div className="bg-[#EDEAFF] pb-20">
        <div className="">
            ...
            <div className="w-full bg-[#CCB0FE] shadow">
                <form onSubmit={handleSubmit} className="flex justify-between items-center gap-5 max-xl:flex-col max-xl:gap-2.5 max-w-7xl mx-auto p-5">
                ...
                <div className="grid grid-cols-3 gap-2.5 w-full mt-10 max-xl:px-5 max-xl:grid-cols-2 max-sm:grid-cols-1">
                    {
                        [...Array(6)].map((_, index) => {
                            return(
                                <div key={index} className="bg-gray-500 h-52 w-full rounded" onClick={handleOpenRegisterModal}>
                ...
                <div className="grid grid-cols-2 gap-2.5 max-lg:grid-cols-1 mt-10">
                    {
                        [...Array(6)].map((_, index) => {
                            return (
                                <div key={index} className="h-40 rounded-lg bg-gray-500 shadow-xl" onClick={handleOpenRegisterModal}>
                            ...
                            customerExperience.map((image) => {
                                return(
                                    <div key={image.id} className="bg-gray-500 h-52 w-full rounded">
                                        <Image height="100%" width="100%" src={image.image} alt="" className="w-full h-full object-cover rounded" />
                                    </div>
                                )
                            })
                        }
                ...
                <div className="grid grid-cols-3 gap-5 w-full mt-10 max-xl:grid-cols-2 max-sm:grid-cols-1">
                    {
                        [...Array(6)].map((_, index) => {
                            return(
                                <div key={index}>
                                    <div className="bg-gray-500 h-52 w-full rounded overflow-hidden">
                                        <Image height="100%" width="100%" src="https://w.ladicdn.com/s650x650/5d070c039197745e067c5e3d/laser-iris-20230801064552-s6s9i.jpg" alt="" className="w-full h-full object-cover rounded"/>
                                    </div>
